...
const cases = [
  { key: '1', id: 'CASE-2026-018', product: '汽车连接器A', abnormal: '针孔', rootCause: '前处理不充分，局部残留', solution: '复查脱脂、水洗和镀液杂质', reuse: 8, savedTime: '约12小时', condition: '镀镍/镀金工艺', confirmer: '张工', updated: '2026-06-25' },
  { key: '2', id: 'CASE-2026-011', product: '新能源端子B', abnormal: '漏镀', rootCause: '脱脂不彻底，局部油污', solution: '加强脱脂工序监控，增加水洗次数', reuse: 5, savedTime: '约8小时', condition: '镀锡/镀镍工艺', confirmer: '李工', updated: '2026-06-20' },
  { key: '3', id: 'CASE-2025-096', product: 'PCB连接器C', abnormal: '麻点', rootCause: '镀液杂质超标', solution: '过滤镀液，检查阳极袋', reuse: 12, savedTime: '约16小时', condition: '镀金工艺', confirmer: '王工', updated: '2026-05-15' },
  { key: '4', id: 'CASE-2026-005', product: '手机中框D', abnormal: '色差', rootCause: '镀液参数波动', solution: '调整电流密度，补充添加剂', reuse: 3, savedTime: '约6小时', condition: '镀镍/电泳工艺', confirmer: '张工', updated: '2026-06-18' },
  { key: '5', id: 'CASE-2026-003', product: '散热片E', abnormal: '镀层厚度异常', rootCause: '电流分布不均', solution: '调整挂具设计，检查阳极位置', reuse: 6, savedTime: '约10小时', condition: '镀镍工艺', confirmer: '赵工', updated: '2026-06-10' },
  { key: '6', id: 'CASE-2025-088', product: '精密五金件F', abnormal: '结合力不足', rootCause: '前处理活化不充分', solution: '优化酸洗活化时间和浓度', reuse: 9, savedTime: '约14小时', condition: '镀铜/镀镍/镀铬', confirmer: '李工', updated: '2026-04-22' },
];
...
const columns = [
  ...
  { title: '适用条件', dataIndex: 'condition', key: 'condition', width: 150 },
...
const Cases: React.FC = () => {
  return (
    <div>
          ...
          {highReuseCases.map((c) => (
            <Col xs={24} md={8} key={c.id}>
              <Card size="small" style={{ background: '#fafafa' }}>
                <div style={{ fontWeight: 600, marginBottom: 8 }}>{c.id} <Tag color="red">{c.abnormal}</Tag></div>
      ...
      <Card title="历史处理案例库">
        <Table columns={columns} dataSource={cases} pagination={false} scroll={{ x: 1400 }} />
      </Card>
    </div>
  );
};
